        ...
        <div>
            ...
            <div>
                <form onSubmit={onSubmit}>
                    <input type={"text"} id={"title"} name={"title"} required onChange={titleChange} value={title}/>
                    <input type={"text"} id={"contents"} name={"contents"} required onChange={contentsChange} value={contents}/>
